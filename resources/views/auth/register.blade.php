                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" class="tm-contact-form mx-auto">
                        ...
                        <div class="form-group">
                            <label for="name" class=" col-form-label text-md-end tm-text-primary">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class=" col-form-label tm-text-primary">{{ __('Confirm Password') }}</label>
